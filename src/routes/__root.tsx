    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-foreground px-5 py-2.5 text-sm font-semibold text-background transition-colors hover:bg-[color:var(--accent-blue)]"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Citadel — Defending Rights. Advancing Justice." },
      {
        name: "description",
        content:
          "Citadel is an independent human-rights NGO providing legal defense, civic education, and media advocacy for the people of Syunik, Armenia.",
      },
      { name: "author", content: "Citadel NGO" },
      { property: "og:title", content: "Citadel — Defending Rights. Advancing Justice." },
      {
        property: "og:description",
        content:
          "Independent legal defense for the communities of Syunik. Together for justice.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600;9..144,700&family=Inter:wght@400;500;600;700&family=Noto+Sans+Armenian:wght@400;500;600;700&display=swap",
      },
    ],
  }),
