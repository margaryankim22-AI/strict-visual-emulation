      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:py-28 lg:grid-cols-12 lg:gap-16">
          ...
          >
            ...
            <h1 className="text-balance font-display text-4xl font-semibold leading-[1.08] md:text-5xl lg:text-6xl">
              <span
                style={{
                  backgroundImage:
                    "linear-gradient(90deg, var(--accent-red), var(--accent-yellow) 50%, var(--accent-blue))",
